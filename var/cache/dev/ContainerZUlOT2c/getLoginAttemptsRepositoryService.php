 ...
 */
class getLoginAttemptsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\LoginAttemptsRepository' shared autowired service.
     *
     * @return \App\Repository\LoginAttemptsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'LoginAttemptsRepository.php';

        return $container->privates['App\\Repository\\LoginAttemptsRepository'] = new \App\Repository\LoginAttemptsRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
