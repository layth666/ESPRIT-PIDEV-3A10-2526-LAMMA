 ...
 */
class getFaceDataRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\FaceDataRepository' shared autowired service.
     *
     * @return \App\Repository\FaceDataRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'FaceDataRepository.php';

        return $container->privates['App\\Repository\\FaceDataRepository'] = new \App\Repository\FaceDataRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
